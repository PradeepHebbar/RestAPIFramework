...
public class TestDelete {
	...
	public void testDeleteServices(Hashtable<String, String> testData) throws IOException, WebServicesException {
		customKeywords = new CustomKeywords();
		customKeywords.deleteResponse(globalData, testData.get("Endpoint"));
