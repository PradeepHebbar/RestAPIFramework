...
public class TestPost {
	...
	public void testPostServices(Hashtable<String, String> testData) throws IOException, WebServicesException{
		customKeywords = new CustomKeywords();
		customKeywords.prepareBody(globalData,testData);		
		customKeywords.postResponse(globalData,testData.get("Endpoint"));
