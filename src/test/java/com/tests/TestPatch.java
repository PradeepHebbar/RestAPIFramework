...
public class TestPatch {
	...
	public void testPatchServices(Hashtable<String, String> testData) throws IOException, WebServicesException{
		customKeywords = new CustomKeywords();
		customKeywords.prepareBody(globalData,testData);		
		customKeywords.patchResponse(globalData,testData.get("Endpoint"));
